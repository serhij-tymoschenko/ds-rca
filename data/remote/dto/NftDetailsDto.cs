...
{
    [JsonProperty("data")]
    public required Data ResData { get; set; }

    public class Data
    {
        [JsonProperty("avatarStorefront")]
        public AvatarStorefront AvatarStorefront { get; set; }
    }
    ...
    public class Node
    {
        ...
        [JsonProperty("artist")]
        public StorefrontArtist Artist { get; set; }
        [JsonProperty("item")]
        public StorefrontItem Item { get; set; }
    }

    public class ProductOffer
    {
        [JsonProperty("pricePackages")]
    ...
    {
        [JsonProperty("redditorInfo")]
        public RedditorInfo RedditorInfo { get; set; }
    }
    ...
    {
        [JsonProperty("avatarOutfit")]
        public AvatarOutfit AvatarOutfit { get; set; }
    }
    ...
    public class AvatarOutfit
    {
        ...
        [JsonProperty("preRenderImage")]
        public PreRenderImage PreRenderImage { get; set; }
    }
